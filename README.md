...
Hardware
ComponentDetailsMicrocontrollerESP32 DOIT DevKit V1DisplaySSD1306 0.96" OLED, 128×64, I2CSensorIR / Light sensor module (digital out)
Wiring
SignalGPIOOLED SDA21OLED SCL22OLED VCC3.3VOLED GNDGNDSensor DO5Sensor VCC3.3VSensor GNDGND
...
BehaviourWeightDescriptionWalk60%Dog walks left and right, tail wagging. Sun shown in background.Eat20%Dog walks to a food bowl, nods while eating, bowl slides off when done.Talk20%Speech bubble with a woof and mood emoji. Moon and stars shown.
...
ActionHowResultPetHold hand over sensor (HIGH > TAP_MAX_MS)Heart eyes, floating heartsTapQuick cover + uncover (HIGH < TAP_MAX_MS)Heart eyes, floating heartsDouble-tapTwo taps within DOUBLE_TAP_MSDog jumps twice with heartsPet while sleepingHold during sleepDog briefly lifts head, heart eyes, goes back to sleepPet while eatingHold during eatPauses head nod, heart eyes
